...
template.innerHTML = `
<link rel="stylesheet" href=${location.href.includes('index.html') ? './styles/app.css' : '../styles/app.css'}>
<svg class="hidden">
...
<div class="container">
        ...
        <nav class="hidden md:flex items-center justify-between py-8 border-b border-light-gray-500 font-YekanBakh">
            ...
            <div class="flex items-center">
                ...
                <ul class="flex items-center gap-x-2.5 lg:gap-x-8 font-YekanBakh-Medium">
                    ...
                    <li class=""><a href=${location.href.includes('index.html') ? './pages/article-page.html?s=normal' : '../pages/article-page.html?s=normal'} class="text-sm md:text-lg hover:text-forest-green-100 transition-all"> مقالات
                        </a>
                    </li>
                    <li class=""><a href=${location.href.includes('index.html') ? './pages/products-page.html?s=گیاه' : 'products-page.html?s=گیاه'} class="text-sm md:text-lg hover:text-forest-green-100 transition-all">محصولات</a></li>
                    <li class=""><a href=${location.href.includes('index.html') ? './pages/contact-us.html' : 'contact-us.html'} class="text-sm md:text-lg hover:text-forest-green-100 transition-all">تماس
                        با ما</a>
                    </li>
                    <li class=""><a href=${location.href.includes('index.html') ? './pages/about-page.html' : 'about-page.html'} class="text-sm md:text-lg hover:text-forest-green-100 transition-all">درباره
                        ما</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="block md:hidden py-3 border-b border-light-gray-500 font-YekanBakh">
            ...
            <!--     search box       -->
            <div class="flex items-center gap-x-2 w-full h-10 bg-light-gray-300 rounded-lg px-3">
...
class Header extends HTMLElement {
    ...
    logOutAccount = () => {
        ...
        document.cookie = `UID = ${this.userId}; path = /;expires = ${now}`
    ...
    connectedCallback() {
        ...
        if (document.cookie.includes('UID')) {
            ...
            this.userProfile.setAttribute('href', `${location.href.includes('index.html') ? './pages/sign-in.html' : 'sign-in.html'}`)
            this.userProfile.innerHTML = `
                    <svg class="w-6 md:h-6">
                        <use href="#login"></use>
                    </svg>
                    ورود/ثبت نام`
            this.mobileUserProfile.setAttribute('href', `${location.href.includes('index.html') ? './pages/sign-in.html' : 'sign-in.html'}`)
            this.mobileUserProfile.innerHTML = `
                    <svg class="w-5 h-5">
                         <use href="#login"></use>
                    </svg>`
            ...
            if (event.keyCode === 13){
                ...
                location.href =`${(()=>{
                    if (location.href.includes('index.html')){
                        ...
                        return `../pages/products-page.html?s=${event.target.value}`
                    }
                })()}`
            }
        })
