                ...
                <div class="flex items-center justify-between mt-4 sm:mt-10">
                    ...
                    <div class="">
                        ...
                        <div class="flex items-center gap-x-4 sm:gap-x-6 mt-3 sm:mt-4">
                            <!--           linkedIn icon                 -->
                            <a href="#" class="block w-5 h-5 sm:w-6 sm:h-6"><img src=${location.href.includes('index.html') ? "./images/social-icon/linkedIn.png" : "../images/social-icon/linkedIn.png"} alt="linkedIn" class="w-full h-full"></a>
                            <!--              telegram icon              -->
                            <a href="#" class="block w-5 h-5 sm:w-6 sm:h-6"><img src=${location.href.includes('index.html') ? "./images/social-icon/telegram.png" : "../images/social-icon/telegram.png"} alt="telegram" class="w-full h-full"></a>
                            <!--               pinteresr icon             -->
                            <a href="#" class="block w-5 h-5 sm:w-6 sm:h-6"><img src=${location.href.includes('index.html') ? "./images/social-icon/pinterest.png" : "../images/social-icon/pinterest.png"} alt="pinterest" class="w-full h-full"></a>
                        </div>
                    </div>
                    <!--         symbol           -->
                    <img src=${location.href.includes('index.html') ? "./images/symbol.png" : "../images/symbol.png"} alt="symbol" class="">
                </div>
            </div>
            <!--     footer plants list       -->
